...
public class DbBackUpMethod {
    ...
    private static Properties pros = getPprVue("conf/properties/dbconfig.properties");
...
//                Process p = cmd.exec(sb.toString());
                String cmdString =
                        "C:/Program Files/MySQL/MySQL Server 5.7/bin/mysqldump.exe --opt -Q bbgs -ubbgs -p4321`qaz  > D:/bbgs.sql ";
                Process p = cmd.exec(cmdString);

...
(function(r) {
  var I, J, K, L, M, N, v, s = {}, w = {}, x = {}, O = {treeId: '',
      ...
      async: {enable: !1,
        ...
        otherParam: [],
        dataFilter: null},
      callback: {beforeAsync: null, beforeClick: null, beforeDblClick: null, beforeRightClick: null, beforeMouseDown: null, beforeMouseUp: null, beforeExpand: null, beforeCollapse: null, beforeRemove: null, onAsyncError: null, onAsyncSuccess: null, onNodeCreated: null, onClick: null, onDblClick: null, onRightClick: null, onMouseDown: null, onMouseUp: null, onExpand: null, onCollapse: null, onRemove: null}}, y = [function(b) {
...
c)
        ...
        var a = b.target, c = h.getSetting(b.data.treeId), d = '', e = null, g = '', k = '', p = null, i = null, q = null; if (j.eqs(b.type, 'mousedown'))k = 'mousedown'; else if (j.eqs(b.type, 'mouseup'))k = 'mouseup'; else if (j.eqs(b.type, 'contextmenu'))k = 'contextmenu'; else if (j.eqs(b.type, 'click')) {
          if (j.eqs(a.tagName, 'span') && a.getAttribute('treeNode' + f.id.SWITCH) !== null) {
            d = j.getNodeMainDom(a).id,
g = 'switchNode'
          } else { if (q = j.getMDom(c, a, [{tagName: 'a', attrName: 'treeNode' + f.id.A}]))d = j.getNodeMainDom(q).id, g = 'clickNode' }
        } else if (j.eqs(b.type, 'dblclick') && (k = 'dblclick', q = j.getMDom(c, a, [{tagName: 'a', attrName: 'treeNode' + f.id.A}])))d = j.getNodeMainDom(q).id, g = 'switchNode'; if (k.length > 0 && d.length == 0 && (q = j.getMDom(c, a, [{tagName: 'a', attrName: 'treeNode' + f.id.A}])))d = j.getNodeMainDom(q).id; if (d.length > 0) {
...
j.apply(c.view.dblClickExpand, [c.treeId, e], c.view.dblClickExpand) ? p = I : g = '' : g = ''; break; case 'clickNode':p = J
    ...
    D = [], E = [], F = [], G = [], H = [], h = {addNodeCache: function(b, a) { h.getCache(b).nodes[h.getNodeCacheId(a.tId)] = a },
      getNodeCacheId: function(b) { return b.substring(b.lastIndexOf('_') + 1) },
      addAfterA: function(b) { E.push(b) },
      addBeforeA: function(b) { D.push(b) },
      addInnerAfterA: function(b) { G.push(b) },
      addInnerBeforeA: function(b) { F.push(b) },
      addInitBind: function(b) { y.push(b) },
      addInitUnBind: function(b) { z.push(b) },
      addInitCache: function(b) { A.push(b) },
      addInitNode: function(b) { B.push(b) },
      addInitProxy: function(b, a) {
        a ? u.splice(0, 0,
b) : u.push(b)
      },
      addInitRoot: function(b) { C.push(b) },
      addNodesData: function(b, a, c, d) { var e = b.data.key.children; a[e] ? c >= a[e].length && (c = -1) : (a[e] = [], c = -1); if (a[e].length > 0 && c === 0)a[e][0].isFirstNode = !1, i.setNodeLineIcos(b, a[e][0]); else if (a[e].length > 0 && c < 0)a[e][a[e].length - 1].isLastNode = !1, i.setNodeLineIcos(b, a[e][a[e].length - 1]); a.isParent = !0; c < 0 ? a[e] = a[e].concat(d) : (b = [c, 0].concat(d), a[e].splice.apply(a[e], b)) },
      addSelectedNode: function(b, a) { var c = h.getRoot(b); h.isSelectedNode(b, a) || c.curSelectedList.push(a) },
      addCreatedNode: function(b, a) { (b.callback.onNodeCreated || b.view.addDiyDom) && h.getRoot(b).createdNodes.push(a) },
      addZTreeTools: function(b) { H.push(b) },
      exSetting: function(b) { r.extend(!0, O, b) },
      ...
      getAfterA: function(b, a, c) { for (var d = 0, e = E.length; d < e; d++)E[d].apply(this, arguments) },
...
arguments)
      ...
      getInnerAfterA: function(b, a, c) { for (var d = 0, e = G.length; d < e; d++)G[d].apply(this, arguments) },
      getInnerBeforeA: function(b, a, c) { for (var d = 0, e = F.length; d < e; d++)F[d].apply(this, arguments) },
      getCache: function(b) { return x[b.treeId] },
      getNodeIndex: function(b, a) { if (!a) return null; for (var c = b.data.key.children, d = a.parentTId ? a.getParentNode() : h.getRoot(b), e = 0, g = d[c].length - 1; e <= g; e++) if (d[c][e] === a) return e; return -1 },
...
? a.getParentNode() : h.getRoot(b), e = 0, g = d[c].length - 1; e <= g; e++) if (d[c][e] === a) return e == g ? null : d[c][e + 1]; return null
      ...
      getNodeByParam: function(b, a, c, d) { if (!a || !c) return null; for (var e = b.data.key.children, g = 0, k = a.length; g < k; g++) { if (a[g][c] == d) return a[g]; var f = h.getNodeByParam(b, a[g][e], c, d); if (f) return f } return null },
      getNodeCache: function(b, a) { if (!a) return null; var c = x[b.treeId].nodes[h.getNodeCacheId(a)]; return c || null },
      ...
      getNodesByParam: function(b, a, c, d) { if (!a || !c) return []; for (var e = b.data.key.children, g = [], k = 0, f = a.length; k < f; k++)a[k][c] == d && g.push(a[k]), g = g.concat(h.getNodesByParam(b, a[k][e], c, d)); return g },
      ...
      getNodesByFilter: function(b, a, c, d, e) { if (!a) return d ? null : []; for (var g = b.data.key.children, k = d ? null : [], f = 0, i = a.length; f < i; f++) { if (j.apply(c, [a[f], e], !1)) { if (d) return a[f]; k.push(a[f]) } var q = h.getNodesByFilter(b, a[f][g], c, d, e); if (d && q) return q; k = d ? q : k.concat(q) } return k },
...
b.data.key.children, d = a.parentTId ? a.getParentNode() : h.getRoot(b), e = 0, g = d[c].length; e < g; e++) if (d[c][e] === a) return e == 0 ? null : d[c][e - 1]; return null
      ...
      getRoot: function(b) { return b ? w[b.treeId] : null },
      getRoots: function() { return w },
      getSetting: function(b) { return s[b] },
      getSettings: function() { return s },
      getZTreeTools: function(b) { return (b = this.getRoot(this.getSetting(b))) ? b.treeTools : null },
      initCache: function(b) { for (var a = 0, c = A.length; a < c; a++)A[a].apply(this, arguments) },
      initNode: function(b, a, c, d, e, g) {
        for (var k =
0, f = B.length; k < f; k++)B[k].apply(this, arguments)
      },
      initRoot: function(b) { for (var a = 0, c = C.length; a < c; a++)C[a].apply(this, arguments) },
      isSelectedNode: function(b, a) { for (var c = h.getRoot(b), d = 0, e = c.curSelectedList.length; d < e; d++) if (a === c.curSelectedList[d]) return !0; return !1 },
      removeNodeCache: function(b, a) { var c = b.data.key.children; if (a[c]) for (var d = 0, e = a[c].length; d < e; d++)h.removeNodeCache(b, a[c][d]); h.getCache(b).nodes[h.getNodeCacheId(a.tId)] = null },
      ...
      setCache: function(b, a) { x[b.treeId] = a },
      setRoot: function(b, a) { w[b.treeId] = a },
      setZTreeTools: function(b, a) { for (var c = 0, d = H.length; c < d; c++)H[c].apply(this, arguments) },
      transformToArrayFormat: function(b, a) {
        if (!a) return []; var c = b.data.key.children, d = []; if (j.isArray(a)) {
...
a[e][c] && (d = d.concat(h.transformToArrayFormat(b, a[e][c])))
    ...
    m = {bindEvent: function(b) { for (var a = 0, c = y.length; a < c; a++)y[a].apply(this, arguments) },
      unbindEvent: function(b) { for (var a = 0, c = z.length; a < c; a++)z[a].apply(this, arguments) },
      bindTree: function(b) {
...
a, m.proxy)
      ...
      unbindTree: function(b) { b.treeObj.unbind('selectstart', v).unbind('click', m.proxy).unbind('dblclick', m.proxy).unbind('mouseover', m.proxy).unbind('mouseout', m.proxy).unbind('mousedown', m.proxy).unbind('mouseup', m.proxy).unbind('contextmenu', m.proxy) },
      doProxy: function(b) { for (var a = [], c = 0, d = u.length; c < d; c++) { var e = u[c].apply(this, arguments); a.push(e); if (e.stop) break } return a },
      proxy: function(b) {
...
(b.ctrlKey || b.metaKey) && h.isSelectedNode(c, a) ? 0 : c.view.autoCancelSelected && (b.ctrlKey || b.metaKey) && c.view.selectedMulti ? 2 : 1; if (j.apply(c.callback.beforeClick, [c.treeId, a, d], !0) == !1) return !0; d === 0 ? i.cancelPreSelectedNode(c, a) : i.selectNode(c, a, d === 2); c.treeObj.trigger(f.event.CLICK, [b, c.treeId, a, d]); return !0
      ...
      }; var j = {apply: function(b, a, c) { return typeof b === 'function' ? b.apply(P, a || []) : c },
          canAsync: function(b, a) { var c = b.data.key.children; return b.async.enable && a && a.isParent && !(a.zAsync || a[c] && a[c].length > 0) },
          clone: function(b) { if (b === null) return null; var a = j.isArray(b) ? [] : {}, c; for (c in b)a[c] = b[c] instanceof Date ? new Date(b[c].getTime()) : typeof b[c] === 'object' ? j.clone(b[c]) : b[c]; return a },
...
'[object Array]'
          ...
          $: function(b, a, c) { a && typeof a !== 'string' && (c = a, a = ''); return typeof b === 'string' ? r(b, c ? c.treeObj.get(0).ownerDocument : null) : r('#' + b.tId + a, c ? c.treeObj : null) },
...
null) return a
          ...
          getNodeMainDom: function(b) { return r(b).parent('li').get(0) || r(b).parentsUntil('li').parent().get(0) },
          isChildOrSelf: function(b, a) { return r(b).closest('#' + a).length > 0 },
          uCanDo: function() { return !0 }}, i = {addNodes: function(b, a, c, d, e) {
           if (!b.data.keep.leaf || !a || a.isParent) {
            if (j.isArray(d) || (d = [d]), b.data.simpleData.enable && (d = h.transformTozTreeFormat(b, d)), a) {
          var g = l(a, f.id.SWITCH, b), k = l(a, f.id.ICON, b), p = l(a, f.id.UL, b); if (!a.open) {
            i.replaceSwitchClass(a, g, f.folder.CLOSE),
i.replaceIcoClass(a, k, f.folder.CLOSE), a.open = !1, p.css({display: 'none'})
          }h.addNodesData(b, a, c, d); i.createNodes(b, a.level + 1, d, a, c); e || i.expandCollapseParentNode(b, a, !0)
        } else h.addNodesData(b, h.getRoot(b), c, d), i.createNodes(b, 0, d, null, c)
          }
         },
           appendNodes: function(b, a, c, d, e, g, k) {
            if (!c) return []; var f = [], j = b.data.key.children, q = (d || h.getRoot(b))[j], l, Q; if (!q || e >= q.length - c.length)e = -1; for (var t = 0, m = c.length; t < m; t++) {
...
a.parentTId && (i.appendParentULDom(b, a.getParentNode()), d = l(a, b)); var e = l(a, f.id.UL, b); e.get(0) && e.remove(); e = i.appendNodes(b, a.level + 1, a[b.data.key.children], a, -1, !1, !0); i.makeUlHtml(b, a, c, e.join('')); d.append(c.join(''))
           ...
           asyncNode: function(b, a, c, d) {
            ...
            var k = {}; for (e = 0, g = b.async.autoParam.length; a && e < g; e++) { var p = b.async.autoParam[e].split('='), n = p; p.length > 1 && (n = p[1], p = p[0]); k[n] = a[p] } if (j.isArray(b.async.otherParam)) for (e = 0, g = b.async.otherParam.length; e < g; e += 2)k[b.async.otherParam[e]] = b.async.otherParam[e + 1]; else for (var q in b.async.otherParam)k[q] = b.async.otherParam[q]; var m = h.getRoot(b)._ver; r.ajax({contentType: b.async.contentType,
          cache: !1,
          type: b.async.type,
...
-1 ? JSON.stringify(k) : k,
          ...
          success: function(g) { if (m == h.getRoot(b)._ver) { var e = []; try { e = !g || g.length == 0 ? [] : typeof g === 'string' ? eval('(' + g + ')') : g } catch (k) { e = g } if (a)a.isAjaxing = null, a.zAsync = !0; i.setNodeLineIcos(b, a); e && e !== '' ? (e = j.apply(b.async.dataFilter, [b.treeId, a, e], e), i.addNodes(b, a, -1, e ? j.clone(e) : [], !!c)) : i.addNodes(b, a, -1, [], !!c); b.treeObj.trigger(f.event.ASYNC_SUCCESS, [b.treeId, a, g]); j.apply(d) } },
...
a); b.treeObj.trigger(f.event.ASYNC_ERROR, [b.treeId, a, c, d, g])
           ...
           cancelPreSelectedNode: function(b, a, c) { var d = h.getRoot(b).curSelectedList, e, g; for (e = d.length - 1; e >= 0; e--) if (g = d[e], a === g || !a && (!c || c !== g)) if (l(g, f.id.A, b).removeClass(f.node.CURSELECTED), a) { h.removeSelectedNode(b, a); break } else d.splice(e, 1), b.treeObj.trigger(f.event.UNSELECTED, [b.treeId, g]) },
          ...
          for (var a = h.getRoot(b); a.createdNodes.length > 0;) {
           ...
           createNodes: function(b, a, c, d, e) { if (c && c.length != 0) { var g = h.getRoot(b), k = b.data.key.children, k = !d || d.open || !!l(d[k][0], b).get(0); g.createdNodes = []; var a = i.appendNodes(b, a, c, d, e, !0, k), j, n; d ? (d = l(d, f.id.UL, b), d.get(0) && (j = d)) : j = b.treeObj; j && (e >= 0 && (n = j.children()[e]), e >= 0 && n ? r(n).before(a.join('')) : j.append(a.join(''))); i.createNodeCallback(b) } },
           destroy: function(b) {
            b && (h.initCache(b),
...
a[k].length > 0) ? (c.hide(), j.apply(e, [])) : c.slideUp(b.view.expandSpeed, e))) : j.apply(e, [])
           ...
           expandCollapseSonNode: function(b, a, c, d, e) {
            var g = h.getRoot(b), f = b.data.key.children, g = a ? a[f] : g[f], f = a ? !1 : d, j = h.getRoot(b).expandTriggerFlag; h.getRoot(b).expandTriggerFlag = !1; if (g) {
...
l; n++)g[n] && i.expandCollapseSonNode(b, g[n], c, f)
           ...
           isSelectedNode: function(b, a) { if (!a) return !1; var c = h.getRoot(b).curSelectedList, d; for (d = c.length - 1; d >= 0; d--) if (a === c[d]) return !0; return !1 },
...
'&gt;'), "'"); b.push('>')
           ...
           makeNodeIcoClass: function(b, a) { var c = ['ico']; a.isAjaxing || (c[0] = (a.iconSkin ? a.iconSkin + '_' : '') + c[0], a.isParent ? c.push(a.open ? f.folder.OPEN : f.folder.CLOSE) : c.push(f.folder.DOCU)); return f.className.BUTTON + ' ' + c.join('_') },
...
: a[b.data.key.icon]; d && c.push('background:url(', d, ') 0 0 no-repeat;'); (b.view.showIcon == !1 || !j.apply(b.view.showIcon, [b.treeId, a], !0)) && c.push('width:0px;height:0px;')
           ...
           makeUlHtml: function(b, a, c, d) { c.push("<ul id='", a.tId, f.id.UL, "' class='", f.className.LEVEL, a.level, ' ', i.makeUlLineClass(b, a), "' style='display:", a.open ? 'block' : 'none', "'>"); c.push(d); c.push('</ul>') },
           makeUlLineClass: function(b,
a) { return b.view.showLine && !a.isLastNode ? f.line.LINE : '' },
           removeChildNodes: function(b, a) { if (a) { var c = b.data.key.children, d = a[c]; if (d) { for (var e = 0, g = d.length; e < g; e++)h.removeNodeCache(b, d[e]); h.removeSelectedNode(b); delete a[c]; b.data.keep.parent ? l(a, f.id.UL, b).empty() : (a.isParent = !1, a.open = !1, c = l(a, f.id.SWITCH, b), d = l(a, f.id.ICON, b), i.replaceSwitchClass(a, c, f.folder.DOCU), i.replaceIcoClass(a, d, f.folder.DOCU), l(a, f.id.UL, b).remove()) } } },
...
g.top) / 2; g = g.translate(f - d.scrollLeft, h - d.scrollTop); e = d
           ...
           setLastNode: function(b, a) { var c = b.data.key.children, d = a[c].length; if (d > 0)a[c][d - 1].isLastNode = !0 },
...
b); j = l(n, f.id.ICON, b); e == c ? e[d].length == 1 ? i.replaceSwitchClass(n, k, f.line.ROOT) : (c = l(e[d][0], f.id.SWITCH, b), i.replaceSwitchClass(e[d][0], c, f.line.ROOTS), i.replaceSwitchClass(n, k, f.line.BOTTOM)) : i.replaceSwitchClass(n, k, f.line.BOTTOM); g.removeClass(f.line.LINE)
           ...
           replaceIcoClass: function(b, a, c) { if (a && !b.isAjaxing && (b = a.attr('class'), b != void 0)) { b = b.split('_'); switch (c) { case f.folder.OPEN:case f.folder.CLOSE:case f.folder.DOCU:b[b.length - 1] = c }a.attr('class', b.join('_')) } },
...
a, c) { if (a) { var d = a.attr('class'); if (d != void 0) { d = d.split('_'); switch (c) { case f.line.ROOT:case f.line.ROOTS:case f.line.CENTER:case f.line.BOTTOM:case f.line.NOLINE:d[0] = i.makeNodeLineClassEx(b) + c; break; case f.folder.OPEN:case f.folder.CLOSE:case f.folder.DOCU:d[1] = c }a.attr('class', d.join('_')); c !== f.folder.DOCU ? a.removeAttr('disabled') : a.attr('disabled', 'disabled') } } },
           ...
           setNodeFontCss: function(b, a) { var c = l(a, f.id.A, b), d = i.makeNodeFontCss(b, a); d && c.css(d) },
...
a))
           ...
           setNodeName: function(b, a) { var c = h.getNodeTitle(b, a), d = l(a, f.id.SPAN, b); d.empty(); b.view.nameIsHTML ? d.html(h.getNodeName(b, a)) : d.text(h.getNodeName(b, a)); j.apply(b.view.showTitle, [b.treeId, a], b.view.showTitle) && l(a, f.id.A, b).attr('title', !c ? '' : c) },
           setNodeTarget: function(b, a) { l(a, f.id.A, b).attr('target', i.makeNodeTarget(a)) },
           setNodeUrl: function(b, a) { var c = l(a, f.id.A, b), d = i.makeNodeUrl(b, a); d == null || d.length == 0 ? c.removeAttr('href') : c.attr('href', d) },
...
a) ? i.expandCollapseNode(b, a, !a.open) : b.async.enable ? i.asyncNode(b, a) || i.expandCollapseNode(b, a, !a.open) : a && i.expandCollapseNode(b, a, !a.open)
          }}; r.fn.zTree = {consts: {className: {BUTTON: 'button', LEVEL: 'level', ICO_LOADING: 'ico_loading', SWITCH: 'switch', NAME: 'node_name'},
...
b.attr('id'); d.treeObj = b; d.treeObj.empty(); s[d.treeId] = d; if (typeof document.body.style.maxHeight === 'undefined')d.view.expandSpeed = ''; h.initRoot(d); b = h.getRoot(d); a = d.data.key.children; c = c ? j.clone(j.isArray(c) ? c : [c]) : []; b[a] = d.data.simpleData.enable ? h.transformTozTreeFormat(d, c) : c; h.initCache(d); m.unbindTree(d); m.bindTree(d); m.unbindEvent(d); m.bindEvent(d); var e = {setting: d,
  ...
  expandAll: function(a) { a = !!a; i.expandCollapseSonNode(d, null, a, !0); return a },
...
a, b)
  ...
  getNodesByFilter: function(a, b, c, e) { b = !!b; return !a || typeof a !== 'function' ? b ? null : [] : h.getNodesByFilter(d, c ? c[d.data.key.children] : h.getNodes(d), a, b, e) },
  ...
  getSelectedNodes: function() { for (var a = [], b = h.getRoot(d).curSelectedList, c = 0, e = b.length; c < e; c++)a.push(b[c]); return a },
  isSelectedNode: function(a) { return h.isSelectedNode(d, a) },
  reAsyncChildNodesPromise: function(a, b, c) { return new Promise(function(d, f) { try { e.reAsyncChildNodes(a, b, c, function() { d(a) }) } catch (h) { f(h) } }) },
  ...
  refresh: function() { this.setting.treeObj.empty(); var a = h.getRoot(d), b = a[d.data.key.children]; h.initRoot(d); a[d.data.key.children] = b; h.initCache(d); i.createNodes(d, 0, a[d.data.key.children], null, -1) },
  removeChildNodes: function(a) {
    if (!a) return null; var b = a[d.data.key.children]
    i.removeChildNodes(d, a); return b || null
  },
  ...
  selectNode: function(a, b, c) { function e() { if (!c) { var b = l(a, d).get(0); i.scrollIntoView(b) } } if (a && j.uCanDo(d)) { b = d.view.selectedMulti && b; if (a.parentTId)i.expandCollapseParentNode(d, a.getParentNode(), !0, !1, e); else if (!c) try { l(a, d).focus().blur() } catch (f) {}i.selectNode(d, a, b) } },
...
a)
  ...
  updateNode: function(a) { a && l(a, d).get(0) && j.uCanDo(d) && (i.setNodeName(d, a), i.setNodeTarget(d, a), i.setNodeUrl(d, a), i.setNodeLineIcos(d, a), i.setNodeFontCss(d, a)) }}; b.treeTools = e; h.setZTreeTools(d, e); b[a] && b[a].length > 0 ? i.createNodes(d, 0, b[a], null, -1) : d.async.enable && d.async.url && d.async.url !== '' && i.asyncNode(d); return e
